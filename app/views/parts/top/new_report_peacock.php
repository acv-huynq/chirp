	...
	<div class="col-md-4 text-left">
					<div class="row">
						...
						<div class="col-md-10 text-left">
							<span style="font-size:150%"><strong>PEACOCK</strong></span>
						</div>
					</div>
				</div>
</div>
		...
		<table id="newReportTable" class="table table-bordered table-hover" border="1" cellpadding="2"  bordercolor="#000000">
			...
			<tbody>
				...
				<tr>
					...
					<td onclick="selectReport(document.forms.mainForm, '/p/chirp/top/select', '<?= HTML::entities($data->report_class) ?>', '<?= HTML::entities($data->report_no) ?>')"><?= HTML::entities($data->departure_date) ?></td>
					...
					<td onclick="selectReport(document.forms.mainForm, '/p/chirp/top/select', '<?= HTML::entities($data->report_class) ?>', '<?= HTML::entities($data->report_no) ?>')"><?= HTML::entities($data->ship_no) ?></td>
